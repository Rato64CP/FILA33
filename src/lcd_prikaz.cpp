...
void lcdPostaviNaSatPrikaz() {
  prikazPoruke = false;
}

void lcdPrikaziPoruku(const char* red1, const char* red2) {
...
void lcdPostaviBlinkanje(bool omoguci) {
...
void lcdOdradiPauzu(unsigned long trajanjeMs) {
